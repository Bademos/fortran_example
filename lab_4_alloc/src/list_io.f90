...
contains
   ...
   subroutine Output_list(Output_File, List, List_Name, Position,res)
      character(*), intent(in)   :: Output_File, Position, List_Name,res
      class(node), allocatable        :: List
      integer  :: Out
